...
<head>
  ...
  <body>
    ...
    <h1 style="text-align: center; font-family: fantasy;" class = "md-6 p-3 mt-5 mr-5 ml-5 p-3  ml-5">Criação de Sessão</h1>
    <br>
     ...
     <h2 style="text-align: left; font-family: fantasy;"class = "md-6 p-3 mt-5 mr-5 ml-5 p-3  ml-5">Criação de Personagens:</h2>
     <br>
    ...
    <form class="container-fluid">
        <h2 style="text-align: left; font-family: fantasy;"class = "md-6 p-3 mt-5 mr-5 ml-5 p-3  ml-5">Lista de Personagens:</h2>  
        <ul class="list-group overflow-auto col-md-6">
