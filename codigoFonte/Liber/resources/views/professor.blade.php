...
<body>
  ...
  <title>{{ config('app.name', 'Liber') }}</title>
    ...
    <button type="button"class="btn btn-light mr-5 btn-lg"> <a href="{{ url('/professor/telaDeCriacao') }}">Criar Sessão</a></button>
    <button type="button"class="btn btn-light mr-5 btn-lg"> <a href="#">Meu Perfil</a></button>
